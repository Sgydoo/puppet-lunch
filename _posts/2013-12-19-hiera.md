...
end-to-end example is provided in this 'ask puppetlabs' post.
...
are represented in YAML, read this.
...
Alternatively, we can use the hiera_include function to enable various
classes from within the hiera data sources:
...
even per node. Using Hiera with Defined Types
